...
export default function EditCategoryForm({
  ...
  category: { id: string; category_name: string; description?: string };
}) {
  const initialState: State = { message: '', errors: {} };
  const updateCategoryWithId = async (prevState: State, formData: FormData) => updateCategory(category.id, prevState, formData);
    ...
    <form action={dispatch}>
      <div className="rounded-md bg-gray-50 p-4 md:p-6">
        ...
        <div className="mb-4">
          ...
          <div id="category-name-error" aria-live="polite" aria-atomic="true">
