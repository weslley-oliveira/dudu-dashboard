...
import { Supplier } from '@/app/lib/suppliers/definitions';
import {
  IdentificationIcon,
  PhoneIcon,
  AtSymbolIcon,
...
import { updateSupplier } from '@/app/lib/suppliers/actions';
...
export default function EditSupplierForm({
  ...
  const updateSupplierWithId = async (prevState: State, formData: FormData) => updateSupplier(supplier.id, prevState, formData);
